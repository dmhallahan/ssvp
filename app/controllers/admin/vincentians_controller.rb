...
class Admin::VincentiansController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Vincentian: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Vincentian: create, read, update, custom_action_for_an_item
  #
