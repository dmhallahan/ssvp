...
class Admin::RecipientsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Recipient: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Recipient: create, read, update, custom_action_for_an_item
  #
